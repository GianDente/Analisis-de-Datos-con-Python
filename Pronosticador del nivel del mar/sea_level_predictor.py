...
def draw_plot():
    ...
    plt.plot(years_extended, intercept + slope * years_extended, 'r', label='fit line 1')  # 𝑦=𝑚𝑥+𝑏 plt.plot() traza una linea en el grafico
    ...
    plt.plot(recent_years_extended, intercept_recent + slope_recent * recent_years_extended, 'g', label='fit line 2') # 𝑦=𝑚𝑥+𝑏
